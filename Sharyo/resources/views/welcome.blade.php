...
<form action="/trips" method="GET">
        ...
        <div style="border-radius:15px" class="input-group">
        <select name="origin" class="form-select" required>
            ...
            <input type="number" class="form-control" name="availableSeats" min="1" max="4" placeholder="Sitios disponibles  " required>
...
<div class="row row-cols-1 row-cols-md-3 g-4">
  ...
  <div class="col">
    <div class="card border-0">
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="card-img-top kirk-icon sc-ksZaOG jucjqW" width="60" height="60" aria-hidden="true"><path fill="none" stroke="#708C91" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M15.5 1.5h-7l-3 11h6l-2 8 10-12h-6z"></path></svg>      <div class="card-body">
